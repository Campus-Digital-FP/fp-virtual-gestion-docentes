    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="panel-container">
                ...
                <p class="text-center">Complete el siguiente formulario para establecer un coordinador.</p>
                ...
                <div class="overflow-x-auto bg-white shadow-md rounded-lg">
                    <table class="min-w-full table-auto text-sm mx-auto">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-4 text-center text-gray-500">No hay coordinadores registrados.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
